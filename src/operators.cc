...
const Operator *const OP_FUN[] = {
    ...
    [0x2E] = new TertiaryOperatorV1<TYPE_STRING, TYPE_STRING, TYPE_INT32, TYPE_INT32, calc::Mid>,
    [0x2F] = new BinaryOperatorV1<TYPE_STRING, TYPE_STRING, TYPE_INT32, calc::Mid>,
    [0x30] = nullptr,
    [0x31] = nullptr,
    [0x32] = nullptr,
    [0x33] = nullptr,
